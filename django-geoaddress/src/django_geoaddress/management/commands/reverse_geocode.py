...
class Command(BaseCommand):
    ...
    help = _("Reverse geocode coordinates to address using geoaddress providers")
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            'latitude',
            type=float,
            help=_('Latitude coordinate'),
        )
        parser.add_argument(
            'longitude',
            type=float,
            help=_('Longitude coordinate'),
        )
        parser.add_argument(
            '--provider',
            type=str,
            help=_('Provider name filter'),
        )
        parser.add_argument(
            '--first',
            action='store_true',
            help=_('Return first result only'),
        )
        parser.add_argument(
            '--format',
            type=str,
