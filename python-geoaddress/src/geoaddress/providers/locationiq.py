...
LOCATIONIQ_ADDRESSES_AUTOCOMPLETE_SOURCE = {
    ...
    'state_code': ['address.ISO3166-2-lvl4', 'address.ISO3166-2-lvl6'],
    'locality': ['address.hamlet', 'address.locality', 'address.isolated_dwelling'],
}
...
class LocationIQProvider(GeoaddressProvider):
    ...
    def get_normalize_state_code(self, data: dict[str, Any]) -> str:
        address = data.get("address", {})
        code = address.get("ISO3166-2-lvl4") or address.get("ISO3166-2-lvl6") or ""
        if code and "-" in code:
    ...
    def get_normalize_locality(self, data: dict[str, Any]) -> str:
        address = data.get("address", {})
        return address.get("hamlet") or address.get("locality") or address.get("isolated_dwelling") or ""
