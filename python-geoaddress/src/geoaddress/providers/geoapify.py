...
GEOAPIFY_ADDRESSES_AUTOCOMPLETE_SOURCE = {
    ...
    'state': ['properties.state', 'properties.state_code', 'properties.region'],
...
class GeoapifyProvider(GeoaddressProvider):
    ...
    def get_normalize_state(self, data: dict[str, Any]) -> str:
        properties = data.get("properties", {})
        return properties.get("state") or properties.get("state_code") or properties.get("region") or ""

    def get_normalize_state_code(self, data: dict[str, Any]) -> str:
        properties = data.get("properties", {})
        return properties.get("state_code") or ""

    def get_normalize_locality(self, data: dict[str, Any]) -> str:
        properties = data.get("properties", {})
        return properties.get("hamlet") or ""
